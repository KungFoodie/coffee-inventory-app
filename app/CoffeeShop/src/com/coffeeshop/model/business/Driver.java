...
import com.coffeeshop.model.data.LocationDao;
import com.coffeeshop.model.domain.Coffee;
import com.coffeeshop.model.domain.Item;
import com.coffeeshop.model.domain.Location;

public class Driver {

    public static void main(String[] args) {
        System.out.println("Creating new location...");
        Location one = new Location(1, "Shop1", 1, "First Street", "city one", 11111, "111-111-1111");
        ...
        LocationDao locData = new LocationDao();
